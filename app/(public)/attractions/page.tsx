...
const ATTRACTIONS: Attraction[] = [
  ...
  },
  {
    num: "No. 02",
    title: "Face Painting",
    desc: "Select a spooky design from our guidebook, and our face painters will weave their magic on you.",
    // TOKEN PRICE NOT SET. Placeholder until Gemma confirms it.
    meta: "Tokens TBC · all ages",
    gradient: "from-pumpkin to-plum",
    image: "/images/attractions/face-painting.webp",
  },
  {
    num: "No. 03",
  ...
  },
  {
    ...
    // TOKEN PRICE NOT SET. Placeholder until Gemma confirms it.
    meta: "Tokens TBC · all ages",
    gradient: "from-rust-deep to-plum",
