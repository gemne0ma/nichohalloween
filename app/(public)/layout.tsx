        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10 py-14">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
            ...
            <div className="flex items-center gap-5">
              <a
                href="https://instagram.com/nicholsonst_halloween"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow us on Instagram"
                className="text-paper/60 hover:text-pumpkin transition-colors"
              >
              ...
              <a
                href="https://www.facebook.com/NicholsonStPublicSchool/"
                target="_blank"
                rel="noopener noreferrer"
          ...
          {/* Divider */}
          <div className="h-px bg-moss/30 mb-8" />

          {/* Bottom row */}
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <p className="font-body text-sm text-paper/50">
              Nicholson Street Public School, 23 Nicholson St, Balmain East NSW 2041
            </p>
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-paper/40">
              A community fundraiser for our beloved school
            </p>
          </div>
        </div>
      </footer>
